...
export const FETCH_RELATIONSHIP = 'FETCH_RELATIONSHIP'
export const FETCH_RELATIONSHIP_COMPLETE = 'FETCH_RELATIONSHIP_COMPLETE'
...
export const SET_RELATIONSHIP_FORM = 'SET_RELATIONSHIP_FORM'
